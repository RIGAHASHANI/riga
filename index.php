...
<body>
    ...
    <header class="hero">
        <div class="hero-overlay" style="pointer-events:none"></div>
        <div class="hero-content container">
            ...
            <form action="/Riga/products.php" method="get" style="display:inline-block; margin:0">
                <button type="submit" class="btn btn-primary">Shop New Arrivals</button>
            </form>
        </div>
    </header>
        ...
        <section id="products" class="products">
            ...
            <div class="product-grid">
                <?php foreach ($products as $p):
                    // Prefer explicit images for known product titles (Silk Blouse, Tailored Blazer)
                    ...
                    // Normalize image path to an absolute URL when image is not an external URL
